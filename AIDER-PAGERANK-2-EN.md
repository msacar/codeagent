...
* **Refactor:** Same pattern—chat files contain bodies; the map supplies cross-references so the LLM can find all impacted symbols and then ask to include more files if needed. ([Aider][2])
