...
class symbols_to_chunks:
    """
    Convert parsed defs/refs for a file to a list of chunks.
    Inputs:
      - file_record: cocoindex LocalFile row (has path/filename)
      - syms: {"defs": [...], "refs": [...]}
    """
    def __call__(self, file_record: Dict[str, Any], syms: Dict[str, Any]) -> List[Dict[str, Any]]:
